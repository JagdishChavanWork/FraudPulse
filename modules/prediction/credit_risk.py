...
USE_CASES = {
    "Stable salaried applicant": "Age 32, income Rs. 85,000, employer tenure 60 months, no missed payments, 4 active tradelines, low recent enquiries.",
    "High enquiry pressure": "Age 29, income Rs. 42,000, employer tenure 18 months, 5 recent enquiries, 3 tradelines opened recently.",
    "Recent delinquency case": "Age 41, income Rs. 58,000, 3 missed payments, recent delinquency level 2, 6 active tradelines.",
    "Thin credit profile": "Age 24, income Rs. 30,000, one active tradeline, short employer tenure, limited credit history.",
}
